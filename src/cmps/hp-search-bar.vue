<template>
    ...
    >
      ...
      ></path>
        ...
        <input class="home-page-search-bar" placeholder='Try: "logo"' autocomplete="off" v-model="filterByCopy.txt">
...
export default {
  ...
  methods: {
    ...
    //TODO: emit to home-page and then the command
    toExplorePage() {
